...
def get_Season(id_index):
    ...
    if id_index >= 25600 and id_index <= 25979:
        ...
        Season = 2018
    elif id_index >= 29720 and id_index <= 30099:
        Season = 2019
    else:
...
def get_player_sofifa_info(counter,Season,Round,player_name_complete,player_name,special_cases,time_labels_up_to):
    ...
    for p in player_name_complete:
        ...
        if unidecode.unidecode(p) == 'Rafael Munoz Benavides': # special case where player is actually in another league: 2B
            player_sofifa_id = [246276]
            print('### WARNING --- I am really player', p)
            print('### WARNING --- I am going to use mock id:', player_sofifa_id)
        if unidecode.unidecode(p) == 'Victor San Bartolome Prieto': # special case where player is actually in another league: 2B
            player_sofifa_id = [189506]
            print('### WARNING --- I am really player', p)
            print('### WARNING --- I am going to use mock id:', player_sofifa_id)
